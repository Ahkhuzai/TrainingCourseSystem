...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2017 at 12:57 PM
...
(23, '$use44rname', '$password', '$email8'),
(26, '$username', '$password', '$email'),
(30, '$username5', '$password', '$email10'),
(31, '$username8', '$password', '$email6'),
(35, '$username150', '$password', '$email128');
...
ALTER TABLE `trainingcourse`
  ADD CONSTRAINT `trainingcourse_ibfk_1` FOREIGN KEY (`tr_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
