...
if(isset($_SESSION['user_id']))
{
    ...
    {   
        if(!empty(trim($_POST['Tname'])))
        {
            ...
            $tr_avg=0;
            $tc_avg=0; 
            $result=$trCourse->addTraining($usrId,null,$Tname,$Tabstract,$Tgoals,$Thours,$Tstart,$Tend,$Tcapacity,$Tstatus,$Tavailable_seat,$handoutDir,$addDate,$startAt,$location,$tr_avg,$tc_avg);    
            if($result)
