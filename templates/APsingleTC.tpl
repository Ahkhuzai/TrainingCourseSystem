...
<script type="text/javascript" src="js/APsingleTC.js"></script>
   ...
   <legend align="right">بيانات الدورة</legend>
    ...
    <form action="APsingleTC.php" method="POST">
    <input type="button" value="طباعة"  name = "print" id='print' class='btn'/> 
    <input type="submit" value="عرض المسجلين"  name = "viewR" id='viewR' class='btn'/> 
    </form>
    </br>
    </fieldset>
    </br>
