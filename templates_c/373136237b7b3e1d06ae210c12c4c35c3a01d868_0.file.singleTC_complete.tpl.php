<?php
/* Smarty version 3.1.30, created on 2017-11-05 10:10:28
  from "C:\xampp\htdocs\rtp_Design\templates\singleTC_complete.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59fed584a88656_18290992',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '373136237b7b3e1d06ae210c12c4c35c3a01d868' => 
    array (
      0 => 'C:\\xampp\\htdocs\\rtp_Design\\templates\\singleTC_complete.tpl',
      1 => 1509873028,
      2 => 'file',
    ),
  ),
...
function content_59fed584a88656_18290992 (Smarty_Internal_Template $_smarty_tpl) {
...
<div style="background-color:#ffffff ;height:100%;width:75%; margin:0 auto;" id="rcorners1" >
    ...
    <center>
        ...
        <div style='margin-top: 10px; font-size: 13px; font-family: Verdana;' id='selection'></div>  
            ...
            <input type="submit" value="ارسال"  name = "send" id='send' class='btn'/>
            <input type="submit" value="طباعة"  name = "print" id='print' class='btn'/>
            <input type="submit" value="حذف"  name = "delete" id='delete' class='btn'/> 
            </br>
            </br>
    </center>
    </fieldset>
